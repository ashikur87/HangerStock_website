...
import GettingStarted from "./Components/Blogs/Buyers/GettingStarted";
        ...
        <Box sx={{ display: "flex" }}>
          ...
          >
            ...
            <Routes>
              ...
              <Route exact path="/how-it-works" element={<GettingStarted />} />
              {/* <Route exact path="/how-it-works" element={<ShopAucLading />} /> */}
              <Route exact path="/allauctions" element={<Shopauction />} />
              <Route exact path="/auctiondetails" element={<AuctionDetail />} />
              <Route
                exact
                path="/sellerauctions"
                element={<SellerAllAuctions />}
              />
              <Route exact path="/how-to-sell" element={<Forseller />} />
              <Route
                exact
                path="/sellerseurope"
                element={<ForsellerEurope />}
              />
              <Route exact path="/smallbusiness" element={<SmallBusiness />} />
              <Route
                exact
              ...
              <Route exact path="/how-to-buy" element={<Forbuyer />} />
              ...
              />
              {/* <Route exact path="/escrow" element={<Escrow />} />  ** remove escrow route*/}
              ...
              {[
                {
                  title: "Shop Auctions",
                  name: [
                    { sub: "How it works?", link: "/how-it-works" },
                    // { sub: "How it works?", link: "/buyersblog/gettingstarted" },
                ...
                },
                {
                  title: "For Buyers",
                  name: [
                    { sub: "How To Buy?", link: "/how-to-buy" },
                ...
                },
                {
                  title: "For Sellers",
                  name: [
                    { sub: "How To sell?", link: "/how-to-sell" },
