...
//get all settings
export const get_region = () => axios.get(`${BASE_URL}/api/region/setting`);
...
export const create_support = (formData) =>
  ...
  //Business location contact us form

export const Business_Location=()=>API.get(`${BASE_URL}/api/region/get/all`)
