...
import img from "../../../Constants/images/smtip1.png";
import Pagination from "@mui/material/Pagination";

import { get_buyers_blog } from "../../../HTTP_REQUESTS/api_";
...
const tips = [
  {
    ...
    details:
      "Lorem ipsum dummy text for an article description.  These should be short, yet informative. Lorem ipsum dummy text for an article description.  These should be short, yet informative. Lorem ipsum dummy text for an article description.  These should be short, yet informative.",
    link: "",
  },
];
...
const AllBlogs = () => {
  ...
  const gotoDetails = (data) => (e) => {
    navigate("/buyersblog/detailpage", { state: data });
  };
