...
const SmallBusiness = () => {
  ...
  return (
    <>
      <div className={Styles.smallBusinessBg}>
        <b.DivOneCon
          style={{
            background: "#599F22",
          }}
        ...
        <d.DivFourCon>
          <div style={{ width: "90%", margin: "50px auto" }}>
            ...
            >
              ...
              information and provide your payment information for the monthly
              fee and you can begin to sell your merchandise immediately to
              buyers waiting to buy your inventory.
            </div>
          </div>
          <d.DivFourInnerCon>
            <d.DivRight>
